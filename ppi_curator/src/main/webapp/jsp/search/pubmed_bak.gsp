...
<body>	
				...
				<div class="col-sm-2">
					<form method="get">
						...
						<div class="sidebar">
							...
							<select id="taxonomy" name="taxonomy" style="width: 100%; margin-bottom: 20px;">
								<option value="*" ${params.taxonomy == '*' ? 'selected' : ''}>All</option>
				...
				<div class="col-sm-8">
					<g:if test="${records}">
						...
						<div class="text-center">
							<ppi_curator:paginate maxsteps="5" params="${['q': params.q, 'ps': params.ps, 'taxonomy': params.taxonomy, 'hl': params.hl, 'ab': params.ab, 'start': params.start, 'end': params.end]}" total="${recordsTotal}" />
						</div>
					</g:if>
				</div>
				<div class="col-sm-2">
					<div class="sidebar">
						...
						<div class="btn-group" style="width: 100%; margin-bottom: 10px;">
							...
							<ul class="dropdown-menu" role="menu" style="width: 100%;">
								<li>
									<g:link action="curate" params="${params + ['ps': 'selected']}">
										Curate Selected
									</g:link>
								</li>
								<li>
									<g:link action="curate" params="${params + ['ps': 'top']}">
										Curate Top ${queryTop}
									</g:link>
								</li>
								<li>
									<g:link action="curate" params="${params + ['ps': 'all']}">
										Curate All
									</g:link>
								</li>
							</ul>
						...
						<div class="btn-group" style="width: 100%; margin-bottom: 10px;">
							...
							<ul class="dropdown-menu" role="menu" style="width: 100%;">
								<li>
									<g:link action="curate" params="${params + ['export': true, 'ps': 'selected']}">
										Export Selected
									</g:link>
								</li>
								<li>
									<g:link action="curate" params="${params + ['export': true, 'ps': 'top']}">
										Export Top ${queryTop}
									</g:link>
								</li>
								<li>
									<g:link action="curate" params="${params + ['export': true, 'ps': 'all']}">
										Export All
									</g:link>
								</li>
							</ul>
	...
	<script type="text/javascript">
		var path = '${createLink(uri: '/search/')}';
		...
		function clearAllSelection() {
			Cookies.set('pubmed-selection', '', {path: path});
			Cookies.set('interaction-selection', '', {path: path});
		}
